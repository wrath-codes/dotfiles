...
function M.register_plug_mappings()
  ...
  vim.keymap.set("n", "<Plug>(AmpSessionWithMessage)", "<cmd>AmpSessionWithMessage<CR>", { desc = "Amp session with message" })
  ...
  vim.keymap.set("n", "<Plug>(AmpMcpAddInteractive)", "<cmd>AmpMcpAddInteractive<CR>", { desc = "Add MCP server (interactive)" })
